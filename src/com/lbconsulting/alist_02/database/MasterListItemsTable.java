...
public class MasterListItemsTable {
    ...
    public static final String[] PROJECTION_ALL = { COL_ID, COL_ITEM_NAME, COL_SELECTED };
    ...
    private static final String DATABASE_CREATE = "create table " + TABLE_MASTER_LIST_ITEMS + " (" + COL_ID
            + " integer primary key autoincrement, " + COL_ITEM_NAME + " text collate nocase, " + COL_SELECTED
            + " integer DEFAULT 0" + ");";
    ...
    public static void onCreate(SQLiteDatabase database) {
        ...
        sqlStatements.add("insert into " + TABLE_MASTER_LIST_ITEMS + "(" + COL_ID + ", " + COL_ITEM_NAME
                + ") values (NULL, 'Potatoes')");
        sqlStatements.add("insert into " + TABLE_MASTER_LIST_ITEMS + "(" + COL_ID + ", " + COL_ITEM_NAME
                + ") values (NULL, 'Relish')");
        sqlStatements.add("insert into " + TABLE_MASTER_LIST_ITEMS + "(" + COL_ID + ", " + COL_ITEM_NAME
                + ") values (NULL, 'Satsumas')");
        sqlStatements.add("insert into " + TABLE_MASTER_LIST_ITEMS + "(" + COL_ID + ", " + COL_ITEM_NAME
