...
public class PreviousCategoryTable {
    ...
    public static final String CONTENT_TYPE= ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + "vnd.lbconsulting." + TABLE_PREVIOUS_CATEGORY;
    public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE +  "/" + "vnd.lbconsulting." + TABLE_PREVIOUS_CATEGORY;
    ...
    private static final String DATABASE_CREATE = "create table "
            ...
            + COL_LIST_TITLE_ID + " integer, "
            + COL_MASTER_LIST_ITEM_ID + " integer, "
    ...
    public static void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
        Log.w(TAG, TABLE_PREVIOUS_CATEGORY + ": Upgrading database from version " + oldVersion + " to version " + newVersion  + ".");
