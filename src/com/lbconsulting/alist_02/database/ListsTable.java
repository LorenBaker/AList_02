...
public class ListsTable {
    ...
    private static final String DATABASE_CREATE = "create table " + TABLE_LISTS + " (" + COL_ID
            + " integer primary key autoincrement, " + COL_LIST_TITLE_ID + " integer, " + COL_MASTER_LIST_ITEM_ID
            + " integer, " + COL_STRUCK_OUT + " integer DEFAULT 0, " + COL_MANUAL_SORT_ORDER + " integer DEFAULT -1, "
