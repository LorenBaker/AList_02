...
public class ListTitlesTable {
	...
	public static final String TABLE_LIST_TITLES = "tblLists";
	...
	public static final String[] PROJECTION_ALL = { COL_ID, COL_LIST_TITLE,
	...
	public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE
			+ "/" + "vnd.lbconsulting." + TABLE_LIST_TITLES;
	...
	private static final String DATABASE_CREATE = "create table "
			+ TABLE_LIST_TITLES + " (" + COL_ID
			+ " integer primary key autoincrement, " + COL_LIST_TITLE
			+ " text collate nocase, " + COL_SORT_ORDER_ID
			+ " integer default 0, " + COL_BACKGROUND_COLOR
			+ " text default '#0000FF', " + COL_NORMAL_TEXT_COLOR
			+ " text default '#FFFFFF', " + COL_STRIKEOUT_TEXT_COLOR
			+ " text default '#D3D3D3', "
