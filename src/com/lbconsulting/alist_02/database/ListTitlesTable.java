...
public class ListTitlesTable {
    ...
    public static final String[] PROJECTION_ALL = {COL_ID, COL_LIST_TITLE, COL_SORT_ORDER_ID, COL_BACKGROUND_COLOR, 
    ...
    public static final String CONTENT_TYPE= ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + "vnd.lbconsulting." + TABLE_LIST_TITLES;
    public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE +  "/" + "vnd.lbconsulting." + TABLE_LIST_TITLES;
