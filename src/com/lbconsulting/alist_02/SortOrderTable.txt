...
public class SortOrdersTable {
    ...
    private static final String DATABASE_CREATE = "create table " + TABLE_SORT_ORDERS + " (" + COL_ID
            + " integer primary key autoincrement, " + COL_SORT_ORDER_NAME + " text collate nocase, "
