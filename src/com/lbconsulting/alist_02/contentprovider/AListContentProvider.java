...
public class AListContentProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
        case MASTER_LIST_MULTI_ROWS:
            // Validate ContentValues keys
            /*
             * sKeys = (String[]) values.keySet().toArray();
             * checkMasterListItemsColumnNames(sKeys);
             */
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (null != db) {
            String groupBy = null;
            String having = null;
            // String query = queryBuilder.buildQuery(projection, selection, groupBy, having, sortOrder, null);
